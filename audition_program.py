# Modification on Gale-Shapley algorithm to match dancers to pieces based on mutual preferences
...
# Piece rankings: list of tuples in form (piece ID, dancer's ranking), sorted by dancer's ranking
...
# Dancer rankings: dict of choreorapher's dancer preferences, key: dancer ID, val: choreographer's
# dancer preference (rank)
...
def checkCanAddDancerToPiece(piece, dancer):
	...
	# dancer is at max number of pieces, checks if they want to drop a piece
		...
		if worstRank > pieceRank:
			# curr piece is higher priority, dancer wants to drop a piece
...
# outputs list of assigned dancers (dancers who were successfully place in a piece) to .csv file
